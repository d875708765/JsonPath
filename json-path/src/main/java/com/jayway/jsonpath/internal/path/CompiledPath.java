...
public class CompiledPath implements Path {
     ...
     *
     * @param path this is our old root path which will become a parameter (assuming there's a scanner terminated by a function
     * @return A function with the scanner as input, or if this situation doesn't exist just the input path
     */
